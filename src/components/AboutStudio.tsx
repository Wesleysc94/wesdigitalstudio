...
export default function AboutStudio() {
 ...
 {/* Background elements */}
 <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-cyan-600 aura:bg-amber-600 ruby:bg-rose-700 dark:bg-cyan-500 aura:bg-amber-500 ruby:bg-rose-600 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/3 pointer-events-none" />
