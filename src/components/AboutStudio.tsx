...
export default function AboutStudio() {
 ...
 {/* Background elements */}
 <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-cyan-600 aura:bg-amber-600 ruby:bg-rose-700/5 dark:bg-cyan-500 aura:bg-amber-500 ruby:bg-rose-600 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/3 pointer-events-none" />
 ...
 >
 <div className="absolute inset-2 border border-cyan-400 aura:border-amber-400 ruby:border-rose-400/30 dark:border-cyan-500 aura:border-amber-500 ruby:border-rose-500/30 rounded-full border-dashed animate-[spin_20s_linear_infinite]" />
 <div className="absolute inset-[14px] border border-cyan-300/50 dark:border-cyan-400 aura:border-amber-400 ruby:border-rose-400/20 rounded-full animate-[spin_30s_linear_infinite_reverse]" />
