...
export default function Solutions() {
 ...
 <div className="absolute top-1/2 left-0 w-[800px] h-[800px] md:w-[1200px] md:h-[1200px] bg-cyan-600 aura:bg-amber-600 ruby:bg-rose-700 dark:bg-cyan-500 aura:bg-amber-500 ruby:bg-rose-600 rounded-full blur-[150px] -translate-y-1/2 -translate-x-1/2 pointer-events-none" />
