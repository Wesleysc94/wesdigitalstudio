...
export default function FooterCTA({ onOpenModal }: { onOpenModal?: () => void }) {
 ...
 <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-[80vw] h-[80vw] max-w-[600px] max-h-[600px] bg-cyan-600 aura:bg-amber-600 ruby:bg-rose-700/5 dark:bg-cyan-500 aura:bg-amber-500 ruby:bg-rose-600 rounded-full blur-[100px] pointer-events-none" />
