        ...
        <section id="case-study" className="py-12 md:py-28 px-6 relative max-w-screen-2xl mx-auto overflow-visible z-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-32 items-center">
                ...
                >
                    ...
                    <h2 className="text-[2.5rem] sm:text-5xl md:text-[5.5rem] lg:text-[6.5rem] xl:text-[8rem] font-serif text-slate-900 dark:text-zinc-50 aura:text-[#F8FAFC] mb-4 md:mb-10 leading-[1] md:leading-[0.9] tracking-tighter">
                    ...
                    <a
                        ...
                        className="group flex gap-2 md:gap-3 items-center justify-center px-8 md:px-10 py-4 md:py-5 border border-cyan-400 aura:border-[#FBBF24] dark:border-cyan-500/50 aura:border-[#FBBF24]/50 text-cyan-700 dark:text-cyan-400 aura:text-[#FBBF24] rounded-full font-sans font-bold uppercase tracking-[0.2em] text-xs md:text-sm hover:bg-cyan-600 hover:text-white dark:hover:bg-cyan-500 dark:hover:text-[#030712] transition-all duration-300 shadow-xl hover:shadow-[0_20px_40px_-15px_rgba(8,145,178,0.4)] hover:-translate-y-1 w-full sm:w-auto text-center"
                    >
                        Investigar projeto
                ...
                <div className="relative w-full h-full flex justify-center items-center py-10 lg:pl-10">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[100%] h-[100%] bg-cyan-400/10 aura:bg-[#FBBF24]/5 dark:bg-cyan-500 aura:bg-[#D4AF37]/10 rounded-full blur-[60px] md:blur-[100px] pointer-events-none" />
