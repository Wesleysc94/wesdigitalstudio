...
export default function WorkProcess() {
 ...
 >
 <h2 className="text-4xl sm:text-5xl md:text-7xl lg:text-[5.5rem] font-serif text-slate-900 dark:text-white aura:text-white ruby:text-white mb-6 md:mb-8 leading-[1.1] md:leading-[1.05] tracking-tight text-balance">
 ...
 <div className="w-24 h-24 rounded-full bg-cyan-50 dark:bg-cyan-900/10 flex items-center justify-center mb-6 group-hover:-translate-y-2 transition-transform duration-300 border border-cyan-200/50 dark:border-cyan-800/50 text-cyan-600 aura:text-amber-500 ruby:text-rose-600 dark:text-cyan-400 aura:text-amber-400 ruby:text-rose-400 group-hover:bg-cyan-100 dark:group-hover:bg-cyan-900/30">
 <step.icon className="w-10 h-10" />
 </div>
 <h3 className="text-xl font-sans font-semibold text-slate-900 dark:text-zinc-50 aura:text-slate-50 ruby:text-slate-50 mb-4">{step.title}</h3>
 <p className="text-slate-600 dark:text-zinc-400 aura:text-zinc-400 ruby:text-zinc-400 font-light leading-relaxed">{step.desc}</p>
 </motion.div>
 ))}
 </motion.div>
 </div>
