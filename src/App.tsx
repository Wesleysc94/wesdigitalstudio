...
function App() {
  ...
  return (
    <div className="relative w-full min-h-screen bg-slate-50 dark:bg-[#0a0a0a] aura:bg-[#09090B] transition-colors duration-500 text-slate-900 dark:text-zinc-50 aura:text-[#F8FAFC] overflow-x-hidden">

      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        <div className="absolute top-[20%] right-[-10%] w-[50vw] h-[50vw] max-w-[800px] max-h-[800px] bg-cyan-900/5 aura:bg-[#FBBF24]/5 dark:bg-white/5 aura:bg-[#FBBF24]/5 blur-[60px] md:blur-[120px] rounded-full mix-blend-screen" />
        <div className="absolute bottom-[10%] left-[-10%] w-[50vw] h-[50vw] max-w-[800px] max-h-[800px] bg-indigo-900/5 aura:bg-transparent dark:bg-white/5 aura:bg-[#FBBF24]/5 blur-[60px] md:blur-[120px] rounded-full mix-blend-screen" />
      </div>
